...
- **상태 $S_t$​** 에서 현재 각 노드가 “얼마나 추가/삭제” 할지 값이 정해져 있음.![[스크린샷 2025-05-18 오전 10.32.52.png]]
- **행동 $A_t$​** 를 통해 각 값을 ±1 또는 그대로 유지.![[스크린샷 2025-05-18 오전 10.33.22.png]]
- 보상 $R_t$ ![[스크린샷 2025-05-18 오전 10.33.40.png]]
