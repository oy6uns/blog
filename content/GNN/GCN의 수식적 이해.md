...
$$\begin{aligned}g_θ \;⋆\;x=Ug_θU^⊤x \;\;\cdot\cdot\cdot\;\;(3)\end{aligned} $$
$$\begin{aligned}
g_θ \;⋆ \;x ≈ θ(I_N + D^{-\frac{1}{2}}AD^{-\frac{1}{2}})x\;\;\cdot\cdot\cdot\;\; (7)\end{aligned}$$
...
$$\begin{aligned}g_θ \;⋆\;x=Ug_\theta(Λ)U^⊤x \;\;\cdot\cdot\cdot\;\; \\(3)\end{aligned}
$$
...
$$ \begin{aligned}
g_{\theta}(\Lambda) =\begin{bmatrix}g_{\theta}(\lambda_0) & & \\& g_{\theta}(\lambda_1) & \\& & \ddots & \\& & & g_{\theta}(\lambda_{N-1})\end{bmatrix}\end{aligned}
$$
...
## 수식 (4)
$$\begin{aligned}g_{θ^′}(Λ) ≈ \sum^K_{k=0} \theta'_kT_k(\tildeΛ)\end{aligned}
$$
...
## 수식(5)
$$ \begin{aligned}
g_θ \;⋆\;x≈\sum^K_{k=0} \theta'_kT_k(\tilde L)x = y\end{aligned}
$$
